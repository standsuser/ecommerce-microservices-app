...
export declare class ListenersController {
    ...
    forkJoinHandlersIfAttached(currentReturnValue: Promise<unknown> | Observable<unknown>, originalArgs: unknown[], handlerRef: MessageHandler): Promise<unknown> | Observable<unknown>;
